    ...
    <div className="flex flex-col items-stretch sm:items-end">
      <div className="flex flex-col sm:flex-row gap-3">
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors min-h-[44px]"
        >
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-4 py-2 border border-indigo-600 text-indigo-600 rounded-md hover:bg-indigo-50 transition-colors min-h-[44px]"
        >
